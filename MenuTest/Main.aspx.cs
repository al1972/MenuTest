    ...
    public partial class Main : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                //SqlDataAdapter da = new SqlDataAdapter("select top 10 id, shortdesc from dbo.buysell order by stampadd desc", cn);
                SqlDataAdapter da = new SqlDataAdapter("select top 10 PostingID, shortdesc from nji.classified order by TimeAdded desc", cn);
